...
dojo.declare('agsjs.dijit._RootLayerTOC', [dijit._Widget], {
  ...
  _getLayerInfos: function() {
    ...
    if (!this.rootLayer.url || (this.rootLayer._layersResponse && this.rootLayer._legendResponse) // O.V.: layers and legend responces are already loaded
            || this.info.noLegend || this.info.noLayers) {
